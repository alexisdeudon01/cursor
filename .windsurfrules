...
- Example: CircleGameDefinition.cs
...
- **NetworkVariables**: Server authority with read permission Everyone
  ...
  ```
- RPC Hub: SessionRpcHub.cs - session management RPCs
...
## Key Files Reference
- **Session isolation logic**: Assets/Scripts/Core/Games/SessionContainer.cs
- **Game plugin interface**: Assets/Scripts/Core/Games/IGameDefinition.cs
- **Server startup**: Assets/Scripts/Networking/Server/ServerBootstrap.cs
- **Architecture diagram**: ARCHITECTURE.md - includes Mermaid class diagram and data flows
